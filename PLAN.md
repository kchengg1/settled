...
| 8+ | **Splitwise-class expansion** | Receipt ↔ group bridge, friends + settle-up hand-offs, reports, file share + iCloud collaboration — see [EXPANSION_PLAN.md](EXPANSION_PLAN.md) | Planned |
